...
tmux send-keys -t chat_server:client4 "/join_group CS428" Enter
...
tmux send-keys -t chat_server:client4 "/leave_group CS428" Enter
tmux send-keys -t chat_server:client5 "/leave_group CS428" Enter
