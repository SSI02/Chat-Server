...
MESSAGE2="Again, Hello from u1"
tmux send-keys -t chat_server:client1 "/broadcast $MESSAGE2" Enter

tmux send-keys -t chat_server:client1 "/exit" Enter

MESSAGE3="Hello from u2"
...
sanity_check "$MESSAGE2" "${TEST_NAME}_client5.log"

sanity_check "$MESSAGE3" "${TEST_NAME}_client3.log"
sanity_check "$MESSAGE3" "${TEST_NAME}_client4.log"
sanity_check "$MESSAGE3" "${TEST_NAME}_client5.log"
