...
#Perform actions
tmux send-keys -t chat_server:client2 "/create_group CS427" Enter
...
tmux send-keys -t chat_server:client3 "/create_group CS430" Enter
sleep 2
tmux send-keys -t chat_server:client1 "/join_group CS427" Enter
tmux send-keys -t chat_server:client1 "/join_group CS428" Enter
tmux send-keys -t chat_server:client1 "/join_group CS429" Enter
tmux send-keys -t chat_server:client1 "/join_group CS430" Enter
...
sanity_check "CS429" "${TEST_NAME}_client1.log"
sanity_check "CS430" "${TEST_NAME}_client1.log"
echo "${TEST_NAME}: PASS"
