...
MESSAGE2="Hello u3"
tmux send-keys -t chat_server:client2 "/msg u3 $MESSAGE2" Enter

MESSAGE3="Hello u4"
tmux send-keys -t chat_server:client3 "/msg u4 $MESSAGE3" Enter

MESSAGE4="Hello u1"
tmux send-keys -t chat_server:client4 "/msg u1 $MESSAGE4" Enter
