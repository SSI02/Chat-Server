...
tmux send-keys -t chat_server:client3 "/group_msg CS427 $MESSAGE2" Enter
tmux send-keys -t chat_server:client4 "/group_msg CS427 $MESSAGE3" Enter
tmux send-keys -t chat_server:client5 "/group_msg CS427 $MESSAGE4" Enter
...
sanity_check "$MESSAGE4" "${TEST_NAME}_client1.log"
echo "${TEST_NAME}: PASS"
