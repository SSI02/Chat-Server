...
tmux send-keys -t chat_server:client2 "/join_group CS427" Enter
tmux send-keys -t chat_server:client3 "/join_group CS427" Enter
tmux send-keys -t chat_server:client4 "/join_group CS427" Enter
tmux send-keys -t chat_server:client5 "/join_group CS427" Enter
tmux send-keys -t chat_server:client2 "/leave_group CS427" Enter
tmux send-keys -t chat_server:client3 "/leave_group CS427" Enter
tmux send-keys -t chat_server:client4 "/leave_group CS427" Enter
tmux send-keys -t chat_server:client5 "/leave_group CS427" Enter
...
sanity_check "left" "${TEST_NAME}_client2.log"
sanity_check "left" "${TEST_NAME}_client3.log"
sanity_check "left" "${TEST_NAME}_client4.log"
sanity_check "left" "${TEST_NAME}_client5.log"
echo "${TEST_NAME}: PASS"
