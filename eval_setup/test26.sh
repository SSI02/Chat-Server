...
tmux send-keys -t chat_server:client2 "/create_group CS428" Enter
sleep 2
...
tmux send-keys -t chat_server:client3 "/create_group CS429" Enter
...
tmux send-keys -t chat_server:client4 "/create_group CS430" Enter
...
tmux send-keys -t chat_server:client5 "/join_group CS427" Enter
tmux send-keys -t chat_server:client5 "/join_group CS428" Enter
tmux send-keys -t chat_server:client5 "/join_group CS429" Enter
tmux send-keys -t chat_server:client5 "/join_group CS430" Enter
tmux send-keys -t chat_server:client5 "/group_msg CS427 $MESSAGE1" Enter
tmux send-keys -t chat_server:client5 "/group_msg CS428 $MESSAGE2" Enter
tmux send-keys -t chat_server:client5 "/group_msg CS429 $MESSAGE3" Enter
tmux send-keys -t chat_server:client5 "/group_msg CS430 $MESSAGE4" Enter
...
sanity_check "CS428" "${TEST_NAME}_client2.log"
sanity_check "CS429" "${TEST_NAME}_client3.log"
sanity_check "CS430" "${TEST_NAME}_client4.log"
sanity_check "$MESSAGE1" "${TEST_NAME}_client1.log"
sanity_check "$MESSAGE2" "${TEST_NAME}_client2.log"
sanity_check "$MESSAGE3" "${TEST_NAME}_client3.log"
sanity_check "$MESSAGE4" "${TEST_NAME}_client4.log"
echo "${TEST_NAME}: PASS"
