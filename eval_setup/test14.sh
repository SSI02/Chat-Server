...
#Perform actions
MESSAGE1="Rohit Sharma finds his groove again"
tmux send-keys -t chat_server:client1 "/msg u2 $MESSAGE1" Enter
tmux send-keys -t chat_server:client2 "/exit" Enter
...
MESSAGE2="India, England look to tick what remains on their CT checklist"
tmux send-keys -t chat_server:client1 "/msg u2 $MESSAGE2" Enter
...
check_output "$MESSAGE2" "${TEST_NAME}_client4.log"
echo "${TEST_NAME}: FAIL"
