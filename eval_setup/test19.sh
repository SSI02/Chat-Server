...
#Perform actions
MESSAGE1="Hello from u1"
tmux send-keys -t chat_server:client1 "/broadcast $MESSAGE1" Enter

MESSAGE2="Hello from u2"
tmux send-keys -t chat_server:client2 "/broadcast $MESSAGE2" Enter

MESSAGE3="Hello from u3"
tmux send-keys -t chat_server:client3 "/broadcast $MESSAGE3" Enter

MESSAGE4="Hello from u4"
tmux send-keys -t chat_server:client4 "/broadcast $MESSAGE4" Enter
...
sanity_check "$MESSAGE3" "${TEST_NAME}_client2.log"
sanity_check "$MESSAGE3" "${TEST_NAME}_client4.log"

sanity_check "$MESSAGE4" "${TEST_NAME}_client1.log"
sanity_check "$MESSAGE4" "${TEST_NAME}_client2.log"
